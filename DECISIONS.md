...
- Reasoning: measured presence rate across all 31 CUAD Distributor Agreement docs for every one of CUAD's 41 clause categories (not guessed). Kept the 6 categories from the original NDA-oriented checklist that still had reasonable coverage in this domain (Governing Law 94%, Non-Compete 42%, Termination-for-Convenience 42%, Cap-on-Liability 68%, Uncapped-Liability 23%, Anti-Assignment 81%). Dropped No-Solicit-of-Employees (6% presence) and IP Ownership Assignment (10%) — both near-absent, expected since neither is core to a distributor relationship. Replaced with Exclusivity (68%) and License Grant (74%) — both central to what a distributor agreement actually negotiates (exclusive vs. non-exclusive territory, what's being licensed to distribute). Uncapped Liability is kept despite thin coverage (23%) deliberately — it's a paired red-flag category with Cap on Liability (absence-of-a-cap is the interesting/rare finding, not something to optimize away for a higher coverage number).
- Rejected: keeping the original NDA-oriented 8 unchanged (would ship 2 checklist items that almost never fire in this domain, weakening the whole "X of Y clauses present" signal); swapping Uncapped Liability for Renewal Term (71% coverage, higher than Uncapped Liability's 23%) — considered, but would lose the deliberate Cap/Uncapped-Liability paired-flag design carried over from the original plan.
